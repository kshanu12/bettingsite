  ...
  return (
    <>
      <div className="fixed w-screen bg-[#161f29] h-16 px-5 shadow-lg shadow-[#131b24] flex items-center justify-between">
        <div
          className="h-16 w-28 md:w-40 font-semibold text-lg md:text-2xl text-white flex gap-4 justify-center items-center cursor-pointer"
          onClick={logoHandler}
        >
        ...
        <div className="h-16 flex items-center text-white gap-2 md:gap-10">
          {props.timer ? (
            <div className="text-[#6ae5a8] flex">
              ...
              <p
                className={`font-bold ${
                  props.timer <= 5 ? styles.heartbeat : ""
                }`}
              >
      ...
      {menuOpen && (
        <div
          className="md:hidden bg-[#1a2531] w-full absolute top-16 left-0 px-4 pt-2"
          style={{ zIndex: 999 }}
        >
          <Link
            href="/profile"
